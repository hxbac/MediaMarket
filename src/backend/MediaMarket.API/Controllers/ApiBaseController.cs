...
namespace MediaMarket.API.Controllers
{
    public class ApiBaseController : ControllerBase
    {
        ...
        public ObjectResult CustomResult<T>(PaginatedResponse<T> response)
        {
            return GetObjectResult(response);
        }

        // Overload for handling List responses
        public ObjectResult CustomResult<T>(PaginatedResponse<List<T>> response)
        {
            return GetObjectResult(response);
        }
        private ObjectResult GetObjectResult<T>(PaginatedResponse<T> response)
        {
