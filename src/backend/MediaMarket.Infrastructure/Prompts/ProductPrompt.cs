namespace MediaMarket.Infrastructure.Prompts
{
    ...
    {
        public class EnhanceInformation : IPromptItem
        {
            public string Instruction => @"You are an assistant specializing in creating engaging product descriptions and tags. You receive a JSON input with the following schema:
                {
