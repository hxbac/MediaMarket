      ...
      <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
        <div className="col-span-2 mb-8">
          <p className="text-lg font-medium text-purple-600">
            Đáng tin cậy trên toàn thế giới
          </p>
          <h2 className="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            Được tin cậy bởi hơn 2 triệu người dùng
          </h2>
          <p className="font-light text-gray-500 sm:text-xl">
            Các tiêu chuẩn tuân thủ và bảo mật nghiêm ngặt của chúng tôi là trọng tâm trong mọi việc chúng tôi làm.
          </p>
