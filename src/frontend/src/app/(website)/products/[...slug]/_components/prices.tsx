...
export default function Prices() {
  return (
    <div className="p-6 border border-gray-200 rounded-xl w-80">
      ...
      <Link href={`/checkout/abc`} className="bg-purple-600 mt-4 text-white font-bold flex items-center justify-center h-11 rounded cursor-pointer hover:opacity-80">Mua</Link>
